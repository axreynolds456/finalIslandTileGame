...
public class TileHandler {
    ...
    private final String waterSpriteSheetPath = "waterSpriteSheet.png";
    private final String pathAndObjects = "PathAndObjects.png";
    private final String treesAndBushes = "trees-and-bushes.png";
    ...
    private TileHandler() {
        ...
        createWorldTiles(pathAndObjects, "PathAndObjects", worldTileArray);
        createWorldTiles(treesAndBushes, "trees-and-bushes", worldTileArray);
